#!/bin/bash
#SBATCH --job-name=lh_kary4_naive
#SBATCH -p batch
#SBATCH --nodes=1
...
#SBATCH --error=logs/kary4_naive_%x_%j.err
#SBATCH --output=logs/kary4_naive_%x_%j.out

# k=4 stacking probe (naive) over patients 01,03,04,05 — companion to
# kary4_single.sh (rope_shift). Together they fill in the k=4 column of
