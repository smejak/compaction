#!/bin/bash
#SBATCH --job-name=lh_kary3_naive
#SBATCH -p batch
#SBATCH --nodes=1
...
#SBATCH --error=logs/kary3_naive_%x_%j.err
#SBATCH --output=logs/kary3_naive_%x_%j.out

# k=3 stacking probe (naive) over patients 01,03,04 — companion to
# kary3_single.sh (rope_shift). Together they fill in the k=3 column of
# the naive-vs-rope scaling figure.
