...
configs=(
  ...
  # "t0.99_summarize      50  0 1 original,all 0.99 ss-plus-repeat summarize"
  # "t0.99_orig2          50  0 1 original,no_context 0.99 ss-plus-repeat summarize"
  # "t0.99_orig3          50  0 1 original,no_context 0.99 ss-plus-repeat summarize"
  # #
  ...
  #
  # ---- KVMerger+AM (KVMerger keys + NNLS beta + LSQ values) ---- #
  # "t0.01_kvmerger+AM          50  0 1 kvmerger+AM 0.01 context-prefill kvmerger 0"
  # "t0.02_kvmerger+AM          50  0 1 kvmerger+AM 0.02 context-prefill kvmerger 0"
  # "t0.05_kvmerger+AM          50  0 1 kvmerger+AM 0.05 context-prefill kvmerger 0"
  # "t0.1_kvmerger+AM           50  0 1 kvmerger+AM 0.1 context-prefill kvmerger 0"
  # "t0.2_kvmerger+AM           50  0 1 kvmerger+AM 0.2 context-prefill kvmerger 0"
)
