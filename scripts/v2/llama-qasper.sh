...
DATASET=qasper
budget_path="head_budget_optimization/head_budgets/Llama-3.1-8B-Instruct/optimized_agnostic.json"

log_dir=logs/qa_evaluation/llama-qasper
